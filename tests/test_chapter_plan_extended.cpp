...
auto main() -> int {
    // build_default_chapters: zero duration
    {
        ...
        test_support::expect_eq(chapters.size(), static_cast<std::size_t>(0), "zero duration should produce no chapters");
    }
    ...
    // build_default_chapters: sub-second duration
    {
        ...
        test_support::expect_eq(
            chapters.size(), static_cast<std::size_t>(0), "sub-second duration should produce no chapters");
    }
    ...
    // build_default_chapters: requested_count = 0
    {
        ...
        test_support::expect_eq(
            chapters.size(), static_cast<std::size_t>(0), "zero requested count should produce no chapters");
    }
    ...
    // build_default_chapters: requested_count = 1
    {
        ...
        test_support::expect_eq(
            chapters.size(), static_cast<std::size_t>(1), "requesting 1 chapter should produce exactly 1");
    ...
    // build_default_chapters: chapters cover full duration without gaps
    {
        ...
        test_support::expect_eq(chapters.size(), static_cast<std::size_t>(10), "should produce requested number of chapters");
