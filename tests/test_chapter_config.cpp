...
auto main() -> int {
    ...
    write_text(json_path, json_config);
    ...
    write_text(yaml_path, yaml_config);
    ...
    write_text(yml_path, yml_config);
    ...
    write_text(unknown_key_path, unknown_key_config);
    ...
    write_text(invalid_time_path, invalid_time_config);
    ...
    write_text(invalid_order_path, invalid_order_config);
