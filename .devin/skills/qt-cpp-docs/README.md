...
| Platform | Command |
|----------|---------|
| **Devin** | Already installed in this repo at `.devin/skills/qt-cpp-docs/` (committed). Auto-discovered; invoke via the `skill` tool or by asking to document Qt/C++ files. |
