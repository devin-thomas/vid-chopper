...
| Platform | Command |
|----------|---------|
| **Devin** | Already installed in this repo at `.devin/skills/qt-project/` (committed). Auto-discovered; invoke via the `skill` tool or by asking to set up/edit Qt 6 CMake. |
