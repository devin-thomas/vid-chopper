...
| Platform | Command |
|----------|---------|
| **Devin** | Already installed in this repo at `.devin/skills/qt-cpp-review/` (committed). Auto-discovered; invoke via the `skill` tool or by asking for a Qt C++ review. See *Running under Devin* in `SKILL.md`. |
