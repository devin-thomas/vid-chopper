...
const workflowSnippets = [
  ...
  "mktemp",
  'elif grep -q "code: 10007" "$deployments_error_log"; then',
  'elif grep -q "code: 10007" "$versions_error_log"; then',
  "Worker vidchopper is not provisioned in this account yet; first deploy will create it.",
